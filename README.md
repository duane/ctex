This is an implementation of TeX in modern C++ written by Duane R. Bailey <bailey.d.r@gmail.com>. However, the main purpose of the project at the moment is not the program itself, but rather an academic study of software engineering.
